...
#define __GMP_CFLAGS "-arch arm64e -target arm64-apple-ios12.1 -march=armv8.3-a+crc+crypto -mcpu=generic -DFFMPEG_KIT_ARM64E -std=c99 -Wno-unused-function -fstrict-aliasing -fembed-bitcode -DIOS -DFFMPEG_KIT_BUILD_DATE=20250415 -Wno-incompatible-function-pointer-types -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.4.sdk -Oz -Wno-ignored-optimization-argument -miphoneos-version-min=12.1 -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS18.4.sdk/usr/include"
